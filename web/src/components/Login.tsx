  ...
  return (
    <div className=" border border-violet-500 rounded-lg font-semibold  px-6 py-4 items-center gap-3 flex flex-col w-96 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <form >
          ...
          <div>
            <a href="/"  className="flex items-center justify-center cursor-pointer rounded-full text-white border-2 border-purple-500 py-2 px-4 text-lg font-bold capitalize bg-purple-500 relative text-center hover:bg-purple-600" >Entrar</a>
          </div>
        </form>
