  ...
  return (
    <div className=" border border-violet-500 font-semibold rounded-lg px-6 py-4 items-center gap-3 flex flex-col w-96">
        ...
        <form >
          ...
          <a href="/"  className="cursor-pointer rounded-full text-white border-2 border-purple-500 py-2 px-4 text-lg font-bold capitalize bg-purple-500 relative text-center hover:bg-purple-600" >Entrar</a>
        </form>
